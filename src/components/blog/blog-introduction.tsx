      ...
      <section className="space-y-4 p-2 bg-[repeating-linear-gradient(-45deg,var(--color-border),var(--color-border)_1px,transparent_1px,transparent_6px)]">
        <header className="space-y-2">
          ...
          <p className="text-base leading-relaxed text-justify text-muted-foreground">
            This wall contains all the content not generated by AI but crafted
            written by me, {name}, a {designation}. The topics I cover include
            web development, design, technology, and my personal experiences as
            a developer.{" "}
          </p>
        </header>
      </section>
