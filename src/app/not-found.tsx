...
export default function NotFound() {
  return (
    <>
      <section className="relative flex min-h-[calc(100vh-16rem)] w-full items-center justify-center px-8 py-16 md:px-0">
        ...
        <div className="relative flex max-w-xl flex-col items-center space-y-6 text-center">
          ...
          <header className="space-y-3">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              The link you followed is no longer available. Head back home or
              jump into the blog to keep exploring the latest updates.
            </p>
          </header>
